...
interface Agent {
  ...
  stats?: {
    ...
    totalCarSales: number,
    totalHouseSales: number
  };
  featured?: boolean;
  CEO?: boolean;
  available?: boolean;
...
function About() {
  const { data } = useSWR<Agent[] | undefined>(
    ['agent'],
    () => agentService.getCeo(),
    {
          ...
          <div className="flex flex-col gap-8">
            <div>
              ...
              <p className="text-foreground/70 leading-relaxed">
                ...
                for families, investors, and businesses. With transparent
                service and verified listings, we help you buy, sell, rent, or
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4 pt-3">
              <div className="bg-primary/10 p-4 rounded-xl text-center">
                <p className="text-3xl font-bold text-primary">{agent[0]?.stats?.totalHouseSales}</p>
                <p className="text-foreground/60 text-sm">Homes Sold</p>
              </div>
              <div className="bg-primary/10 p-4 rounded-xl text-center">
                <p className="text-3xl font-bold text-primary">{agent[0]?.stats?.totalCarSales}</p>
                <p className="text-foreground/60 text-sm">Cars Delivered</p>
              </div>
              <div className="bg-primary/10 p-4 rounded-xl text-center">
                <p className="text-3xl font-bold text-primary">{agent[0]?.user.rating}%</p>
